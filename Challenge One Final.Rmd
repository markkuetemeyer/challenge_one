...
Answer:Yes, there are outliers in the income_average. By looking to the median which is 53,777 and the 3rd Quartile that is 60148, we notice the max value ( 14281500) is extremely compared to this percentilence. hence, we can affirm that there are outliers.
